...
const Header = () => {
  return (
    <>
      <div className='menu-area menu-sticky' id='personalID'>
                            ...
                            <div className='mega-menu-innner'>
                              <div className='single-megamenu'>
                                <ul className='sub-menu'>
                                  ...
                                  <li>
                                    <a href='index5.html'>Distance Learning</a>{" "}
                                  </li>
                                </ul>
                              </div>
                              <div className='single-megamenu'>
                      ...
                      <li className='menu-item-has-children'>
                        ...
                        <ul className='sub-menu'>
                          ...
                          <li className='menu-item-has-children'>
                            ...
                            <ul className='sub-menu right'>
                              <li>
                                <a href='gallery-style1.html'>Gallery One</a>
                              </li>
                              <li>
                                <a href='gallery-style2.html'>Gallery Two</a>
                              </li>
                              <li>
                                <a href='gallery-style3.html'>Gallery Three</a>
                              </li>
                            </ul>
                          </li>
                          <li className='menu-item-has-children'>
